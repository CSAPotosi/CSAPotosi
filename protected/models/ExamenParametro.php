 ...
 *
 * The followings are the available columns in table 'examen_parametro':
 * @property integer $id_serv
 * @property integer $id_par
 * @property integer $orden
 */
class ExamenParametro extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_par', 'required'),
			array('id_serv, id_par, orden', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_serv, id_par, orden', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ExamenParametro the static model class
	 */
