...
class Pais extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('cod_pais, nombre_pais', 'required'),
            array('cod_pais', 'length', 'max' => 4),
            array('nombre_pais', 'length', 'max' => 64),
            array('gentilicio', 'length', 'max' => 32),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('cod_pais, nombre_pais, gentilicio', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            'personas' => array(self::HAS_MANY, 'Persona', 'nacionalidad'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('gentilicio', $this->gentilicio, true);
