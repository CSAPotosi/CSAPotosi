...
class AsignacionEmpleado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('fecha_fin, vigente', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_asignacion, fecha_inicio, fecha_fin, vigente, id_empleado, id_cargo', 'safe', 'on' => 'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'cargo' => array(self::BELONGS_TO, 'Cargo', 'id_cargo'),
