...
/**
 * This is the model class for table "prestacion_servicios".
 *
 * The followings are the available columns in table 'prestacion_servicios':
 ...
 */
class PrestacionServicios extends CActiveRecord
{
    /**
     ...
     * @return PrestacionServicios the static model class
     */
