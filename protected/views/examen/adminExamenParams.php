            ...
            <div class="jarviswidget jarviswidget-color-blue" id="widget1" data-widget-refreshbutton="false">
                ...
                <div>
                    <div class="widget-body">
                        ...
                        <?php echo CHtml::errorSummary($epList,'<h4 class="alert-heading"><i class="fa fa-warning"></i> Debe corregir los siguientes errores:</h4>',null,['class'=>'alert alert-danger error-message']);?>
                        ...
                        <table id="table-selected-params" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th width="30%">EXTENSION/UNIDAD</th>
                            </tr>
                            </thead>
                            <tbody>
