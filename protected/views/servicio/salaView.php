                ...
                <div>
                    <div class="widget-body">
                        ...
                        <table class="table table-bordered table-hovered" id="t-sala-detail" data-activo="<?php echo $tSala->servicio->activo;?>" >
                            ...
                            <tr>
                                <th style="text-align: right" width="20%">NOMBRE</th>
                            ...
                            <tr>
                                <th style="text-align: right" width="20%">TIPO DE GRUPO</th>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <?php
                                        if($tSala->servicio->activo)
                                            ...
                                            echo "<span class='label label-danger error-message'>INACTIVO</span>";
                                    ?>
                                </td>
                            </tr>
                        </table>
                                ...
                                <div class="well well-sm item-sala-new-form hidden">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <?php echo $form->error($itemSalaModel,'cod_sala',['class'=>'label label-danger error-message']);?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php echo $form->textField($itemSalaModel,'ubicacion_sala',['class'=>'form-control','placeholder'=>'UBICACION']);?>
                                            <?php echo $form->error($itemSalaModel,'ubicacion_sala',['class'=>'label label-danger error-message']);?>
                                        </div>
                                        <div class="col-md-1">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="row hidden item-sala-form">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <?php echo $form->error($itemSala,'cod_sala',['class'=>'label label-danger error-message']);?>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <?php echo $form->textField($itemSala,'ubicacion_sala',['class'=>'form-control']);?>
                                                        <?php echo $form->error($itemSala,'ubicacion_sala',['class'=>'label label-danger error-message']);?>
                                                    </div>
                                                    <div class="col-md-1">
                                                <span class="onoffswitch">
