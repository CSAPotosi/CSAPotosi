<?php echo CHtml::beginForm(array(), 'post', array()); ?>
    <div class="form-group">
        ...
        <?php echo CHtml::error($modelCargo, 'nombre_cargo', array('class' => 'label label-danger error-message')); ?>
    </div>
    <div class="form-group">
        ...
        <?php echo CHtml::error($modelCargo, 'descripcion_cargo', array('class' => 'label label-danger error-message')); ?>
    </div>
    <div class="form-group">
