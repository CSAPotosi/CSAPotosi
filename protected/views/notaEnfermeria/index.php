                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="margin-bottom-10<?php echo ($neModel->hasErrors())?'':' hidden';?>" id="new-nota">
                                <?php echo CHtml::errorSummary($neModel,'<h4 class="alert-heading"><i class="fa fa-warning"></i> Debe corregir los siguientes errores:</h4>',null,['class'=>'alert alert-danger']);?>
                                <div class="row">
