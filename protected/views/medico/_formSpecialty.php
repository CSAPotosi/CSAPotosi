...
<div class="form">
    ...
    <div class="form-group">
        ...
        <?php echo $form->error($modelEspecialidad, 'nombre_especialidad', array('class' => 'label label-danger error-message')); ?>
    </div>
    <div class="form-group">
        ...
        <?php echo $form->error($modelEspecialidad, 'descripcion', array('class' => 'label label-danger error-message')); ?>
    </div>
    <?php $this->endWidget(); ?>
</div>