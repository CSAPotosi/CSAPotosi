...
<fieldset>
	...
	<?php echo CHtml::errorSummary($modelEntidad, '<h4 class="alert-heading"><i class="fa fa-warning"></i> DEBE CORREGIR LOS SIGUIENTES ERRORES </h4>', null, array('class' => 'alert alert-danger error-message')); ?>
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				...
				<?php echo CHtml::error($modelEntidad, 'razon_social', array('class' => 'label label-danger error-message')); ?>
			</div>
			<div class="form-group">
				...
				<?php echo CHtml::error($modelEntidad, 'nit', array('class' => 'label label-danger error-message')); ?>
			</div>
			<div class="form-group">
				...
				<?php echo CHtml::error($modelEntidad, 'direccion', array('class' => 'label label-danger error-message')); ?>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<?php echo CHtml::error($modelEntidad, 'telefono', array('class' => 'label label-danger error-message')); ?>
			</div>
			<div class="form-group">
				...
				<?php echo CHtml::error($modelEntidad, 'tipo_entidad', array('class' => 'label label-danger error-message')); ?>
			</div>
			<div class="form-group">
				...
				<?php echo CHtml::error($modelEntidad, 'naturaleza_juridica', array('class' => 'label label-danger error-message')); ?>
			</div>
		</div>
	</div>
	<div class="row">
