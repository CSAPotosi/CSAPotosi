				...
				<div class="jarviswidget jarviswidget-color-blue" id="widget1">
					...
					<div>
						<div class="widget-body">
							...
							<?php echo CHtml::beginForm(array('mayor/index'),'get',array('class'=>'form-horizontal')); ?>
							<div class = 'row' >
								<div class='col-md-4'>
									<?php echo CHtml::hiddenField("id_cuenta",'',['class'=>'form-control', 'id'=>'id_cuenta']);?>
									<label for='codigocuenta' class='col-md-4 control-label'>CODIGO DE LA CUENTA</label>
									<div class = 'col-md-8'>
										<?php echo CHtml::textField('codigocuenta',(($cuenta=='')?'':$cuenta->codigo),['class'=>'form-control codigoinput','placeholder'=>'Doble Click Aqui']); ?>
									</div>
								</div>
								<div class="col-md-3">
...
<?php
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . '/resources/js/system/mayor/index.js', CClientScript::POS_END);
