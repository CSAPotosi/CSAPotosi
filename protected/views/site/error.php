		...
		<div class="row">
			<div class="col-sm-12">
				<div class="text-center error-box">
					<h1 class="error-text-2 bounceInDown animated"> Error <?php echo $code; ?> <span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span></h1>
					<h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> <?php echo CHtml::encode($message); ?></strong></h2>
					<br />
					<p class="lead">
						Contactate con el administrador o intenta de nuevo. Usa el boton <b>Atras</b> de tu navegador para regresar donde estabas antes
					</p>
