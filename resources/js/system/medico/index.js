...
function getMedicoListAjax() {
    var pageAttr = $("#btn-load-patients").attr("data-page");
    var queryAttr = $("#input-search-medicos").val();
    $.ajax({
...
$("#input-search-medicos").on("keyup", function (e) {
